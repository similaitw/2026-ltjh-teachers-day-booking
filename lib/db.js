...
// Acquire the lock in a separate statement so the following query sees all
// changes committed while waiting for the lock (READ COMMITTED snapshot).
export async function withEventLock(sql, eventId, query) {
